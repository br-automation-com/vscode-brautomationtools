...
function checkNodeIsArray(tagName: string, jPath: string, isLeafNode: boolean, isAttribute: boolean): boolean {
...
function checkNodeIsArrayRegex(tagName: string, jPath: string, isLeafNode: boolean, isAttribute: boolean): boolean {
    ...
    return isAttribute //
        ? false
        : nodePathIsObjectsRegEx.test(jPath)
        ? true
        : nodePathIsFilesRegEx.test(jPath)
        ? true
        : nodePathIsConfigurationsRegEx.test(jPath)
        ? true
        : false;
}

function updateTag(tagName: string, jPath: string, attrs: { [k: string]: string }): string | boolean {
