...
export class CpuPackageFile extends AsPackageFile {
     ...
     */
    public static async createFromFile(filePath: Uri): Promise<CpuPackageFile | undefined> {
    ...
    #logWarningsForMissingProperties() {
...
function getCpuConfiguration(rootElement: ParsedXmlObject): CpuConfiguration {
    ...
    const ansiCIncludeDirs = typeof ansiCIncludeDirsRaw === 'string' ? splitShellArgs(ansiCIncludeDirsRaw) : [];
