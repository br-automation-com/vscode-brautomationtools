 ...
 */
export class AsPackageFileNew extends AsXmlFile {
     ...
     */
    public static async createFromPath(filePath: Uri): Promise<AsPackageFileNew | undefined> {
        // Create and initialize object
        try {
            const xmlFile = new AsPackageFileNew(filePath);
    ...
    public get dirPath(): Uri {
        if (!this.#isInitialized || !this.#dirPath) { throw new Error(`Use of not initialized ${AsPackageFileNew.name} object`); }
        return this.#dirPath;
    }
    ...
    public get type(): string {
        if (!this.#isInitialized || !this.#type) { throw new Error(`Use of not initialized ${AsPackageFileNew.name} object`); }
        return this.#type;
    }
    ...
    public get subType(): string | undefined {
        if (!this.#isInitialized) { throw new Error(`Use of not initialized ${AsPackageFileNew.name} object`); }
        return this.#subType;
    }
    ...
    public get childObjects(): AsPackageObject[] {
        if (!this.#isInitialized || !this.#childObjects) { throw new Error(`Use of not initialized ${AsPackageFileNew.name} object`); }
